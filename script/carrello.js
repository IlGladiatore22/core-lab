...
function loadCart() {
    ...
    // Per ora mostriamo il carrello vuoto. 
    // In futuro potrai implementare la logica per leggere i prodotti da LocalStorage qui.
    container.innerHTML = 
        '<div class="cart-empty">' +
            '<i class="fa-solid fa-cart-shopping"></i>' +
            '<h3>Il tuo carrello è vuoto</h3>' +
            '<p>Sembra che tu non abbia ancora aggiunto nessun prodotto.</p>' +
            '<a href="prodotti.html" class="cart-btn-back"><i class="fa-solid fa-arrow-left"></i> Torna ai Prodotti</a>' +
        '</div>';
}

// ===== START =====
if (initUser()) loadCart();
